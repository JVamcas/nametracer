...
import com.petruskambala.nametracer.databinding.NavHeaderMainBinding
import com.petruskambala.nametracer.model.AccountType
import com.petruskambala.nametracer.ui.account.AccountViewModel
import com.petruskambala.nametracer.ui.cases.CaseViewModel
...
class MainActivity : AppCompatActivity(), NavigationView.OnNavigationItemSelectedListener {
    ...
    private lateinit var caseModel: CaseViewModel
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        visitModel = ViewModelProvider(this).get(VisitViewModel::class.java)
        caseModel = ViewModelProvider(this).get(CaseViewModel::class.java)
